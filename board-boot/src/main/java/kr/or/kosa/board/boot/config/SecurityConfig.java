package kr.or.kosa.board.boot.config;
...
import kr.or.kosa.board.boot.member.handler.AuthFailureHandler;
import kr.or.kosa.board.boot.member.handler.AuthSucessHandler;
import kr.or.kosa.board.boot.service.MemberService;
